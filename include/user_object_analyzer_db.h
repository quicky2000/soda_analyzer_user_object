...
namespace osm_diff_analyzer_user_object
{
  ...
  public:
    ...
    void insert(const osm_api_data_types::osm_node & p_node);
    void insert(const osm_api_data_types::osm_way & p_way);
    void insert(const osm_api_data_types::osm_relation & p_relation);
    ...
    bool contains(const osm_api_data_types::osm_core_element & p_element);
  private:
